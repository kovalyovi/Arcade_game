...
var Engine = (function(global) {
    ...
    canvas.width = 505 + 101;
    canvas.height = 606 + 83;
    ...
    function updateEntities(dt) {
        ...
        document.querySelector('.lives-text').innerHTML = lives.toString();
        killZombies();
        addNewEnemies();
        checkLives();
    }
    ...
    function addNewEnemies() {
        while (allEnemies.length < 4) {
            ...
            allEnemies.push(new Enemy(position, direction));
        }
    }

    function killZombies() {
        allEnemies = allEnemies.filter(enemy => enemy.alive);
        gems = gems.filter(gem => gem.alive);
    }
